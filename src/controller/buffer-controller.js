...
class BufferController extends EventHandler {
  ...
  onMediaSourceOpen() {
    ...
    this.wfs.trigger(Event.MEDIA_ATTACHED, {media:this.media, url: this.url, protocol: this.protocol, channelName:this.channelName, mediaType: this.mediaType, websocketName:this.websocketName});
  }
